...
export default function CardRequireLearning({ course, isSmall }: CardRequireLearningProps) {
  ...
  return (
    <TouchableOpacity onPress={() => onClickDetail(course?.id)} style={styles.card}>
      <View style={isSmall ? styles.imageContainerSmall : styles.imageContainer}>
        <Image source={imageSource} style={isSmall ? styles.imageSmall : styles.image} />
        {course?.duration && (
      ...
      <View style={isSmall ? styles.contentSmall : styles.content}>
        ...
        <Text style={isSmall ? styles.titleSmall : styles.title} numberOfLines={2}>
          {course?.title}
        </Text>
      </View>
    </TouchableOpacity>
